...
namespace Clinic.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Appointment.Include(a => a.AppointmentType).Include(a => a.Doctor).Include(a => a.Patient);
        ...
        public async Task<IActionResult> Create([Bind("Id,DoctorId,PatientId,Reservation,AppointmentId")] Appointment appointment)
        {
            ...
            ViewData["AppointmentId"] = new SelectList(_context.AppointmentType, "Id", "Type", appointment.AppointmentId);
            ViewData["DoctorId"] = new SelectList(_context.Doctor, "Id", "DoctorName", appointment.DoctorId);
            ViewData["PatientId"] = new SelectList(_context.Patient, "Id", "PatientName", appointment.PatientId);
            return View(appointment);
        }
